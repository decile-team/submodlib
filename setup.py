...
ext_modules = [
    Pybind11Extension("submodlib_cpp",
        ...
        ["cpp/wrappers/wrapper.cpp", "cpp/submod/FacilityLocation.cpp", "cpp/wrappers/wr_FacilityLocation.cpp", "cpp/submod/DisparitySum.cpp", "cpp/wrappers/wr_DisparitySum.cpp", "cpp/submod/FeatureBased.cpp", "cpp/wrappers/wr_FeatureBased.cpp", "cpp/submod/GraphCut.cpp", "cpp/wrappers/wr_GraphCut.cpp", "cpp/submod/SetCover.cpp", "cpp/wrappers/wr_SetCover.cpp", "cpp/submod/ProbabilisticSetCover.cpp", "cpp/wrappers/wr_ProbabilisticSetCover.cpp", "cpp/submod/DisparityMin.cpp", "cpp/wrappers/wr_DisparityMin.cpp", "cpp/utils/helper.cpp", "cpp/wrappers/wr_helper.cpp","cpp/utils/sparse_utils.cpp", "cpp/wrappers/wr_sparse_utils.cpp","cpp/optimizers/NaiveGreedyOptimizer.cpp", "cpp/optimizers/LazyGreedyOptimizer.cpp", "cpp/optimizers/StochasticGreedyOptimizer.cpp", "cpp/optimizers/LazierThanLazyGreedyOptimizer.cpp", "cpp/SetFunction.cpp","cpp/Clustered.cpp", "cpp/wrappers/wr_Clustered.cpp"],
