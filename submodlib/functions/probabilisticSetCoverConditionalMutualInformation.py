# probabilisticSetCoverConditionalMutualInformation.py
...
class ProbabilisticSetCoverConditionalMutualInformationFunction(SetFunction):
	...
	def __init__(self, n, num_concepts, probs, query_concepts, private_concepts, concept_weights=None):
		self.n = n
		...
		self.cpp_obj = ProbabilisticSetCoverConditionalMutualInformation(self.n, self.num_concepts, self.probs, self.concept_weights, self.query_concepts, self.private_concepts)
