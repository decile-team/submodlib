...
class ConditionalGainFunction(SetFunction):
	"""Implementation of the Conditional Gain of a submodular function
	...
	Given a set of items :math:`B \\subseteq \\Omega`, the conditional gain is the gain in function value by adding :math:`B` to :math:`A`
