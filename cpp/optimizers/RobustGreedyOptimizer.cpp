...
#include<utility>
#include<random>
#include"RobustGreedyOptimizer.h"

RobustGreedyOptimizer::RobustGreedyOptimizer(){}

bool RobustGreedyOptimizer::equals(double val1, double val2, double eps) {
...
std::vector<std::pair<ll, double>> RobustGreedyOptimizer::maximize(SetFunction &f_obj, float budget, bool stopIfZeroGain, bool stopIfNegativeGain, float epsilon, bool verbose, bool showProgress, const std::vector<float>& costs, bool costSensitiveGreedy) {
