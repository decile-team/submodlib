...
public:
	...
	std::vector<std::pair<ll, double>> maximize(std::string optimizer, ll budget, bool stopIfZeroGain, bool stopIfNegativeGain, float epsilon, bool verbose, bool showProgress);
