...
std::vector<std::pair<ll, double>> SetFunction::maximize(std::string optimizer, ll budget, bool stopIfZeroGain, bool stopIfNegativeGain, float epsilon, bool verbose, bool showProgress, const std::vector<int>& costs, bool costSensitiveGreedy){
